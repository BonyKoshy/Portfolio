  ...
  return (
    <div className="group space-y-6 flex flex-col h-full">
      <div className="space-y-6 flex flex-col grow">
        <div
          className="overflow-hidden rounded-(--radius-card) w-full bg-panel shadow-sm border border-transparent group-hover:border-prelayer-2 transition-colors duration-300 cursor-pointer"
