  ...
  return (
    <div className="inline-block relative">
      <label
        ...
        className="group relative grid place-items-center w-12 h-12 bg-(--panel-bg) rounded-full cursor-pointer shadow-[0_0_20px_2px_rgba(0,0,0,0.05)] transition-colors duration-300 z-10 text-(--text-primary)"
