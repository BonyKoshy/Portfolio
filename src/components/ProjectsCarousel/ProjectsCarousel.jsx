    ...
    <>
      ...
      <div className="carousel-controls">
        ...
        <div className="nav-buttons">
          <button onClick={() => scroll(-1)} disabled={isAtStart}>
            <ArrowLeft size={24} />
          </button>
          <button onClick={() => scroll(1)} disabled={isAtEnd}>
            <ArrowRight size={24} />
          </button>
        </div>
      </div>
...
export const Card = ({ card }) => {
  return (
    <motion.div layoutId={`card-${card.title}`} className="card-content">
      ...
      <div className="card-details">
        ...
        <motion.h2 layoutId={`card-title-${card.title}`} className="card-title">
          {card.title}
        </motion.h2>
      </div>
    </motion.div>
