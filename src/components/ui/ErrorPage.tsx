...
export const ErrorPage: React.FC<ErrorPageProps> = ({
  ...
  return (
    ...
    >
      ...
      {/* Container Tile */}
      <div className="bg-bg-elevated border border-border-default rounded-sm p-8 md:p-12 max-w-2xl w-full flex flex-col gap-8 relative overflow-hidden group hover:border-accent-primary transition-colors duration-0">
        {/* Top Header / Motif */}
        ...
        <div className="pt-2 relative z-10">
          <Link
            to="/"
            className="cursor-target inline-flex items-center gap-3 bg-bg-surface border border-border-default text-fg-primary px-6 py-3 font-mono text-sm hover:border-accent-primary hover:text-accent-primary hover:bg-accent-primary/10 transition-colors duration-0"
          >
            <ArrowLeft size={16} />
