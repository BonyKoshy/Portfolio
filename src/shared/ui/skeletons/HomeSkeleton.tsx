  ...
  return (
    <div className="w-full animate-pulse">
        ...
        <Container>
          <div className="flex flex-col items-start w-full">
            ...
            <div className="mb-6 w-full max-w-5xl space-y-2">
              <div className="h-10 sm:h-14 lg:h-18 w-3/4 bg-bg-subtle rounded-lg"></div>
              <div className="h-10 sm:h-14 lg:h-18 w-2/3 bg-bg-subtle rounded-lg"></div>
            </div>
      ...
      <section className="min-h-screen lg:h-screen flex flex-col justify-center mx-auto max-w-7xl px-6 w-full py-20 lg:py-0">
        <div className="grid grid-cols-1 grid-rows-10 md:grid-cols-6 md:grid-rows-4 h-auto md:min-h-175 md:h-[calc(100vh-12rem)] md:max-h-225 gap-4 w-full">
          {/* 1. Profile (2x2) */}
