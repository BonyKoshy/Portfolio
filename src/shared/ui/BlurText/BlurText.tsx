...
const BlurText: React.FC<BlurTextProps> = ({
  ...
  const safeFrom = fromSnapshot as Record<string, string | number>;
  const safeTo = toSnapshots as Array<Record<string, string | number>>;
  ...
  return (
    <p ref={ref} className={`blur-text ${className} flex flex-wrap`}>
      {elements.map((segment, index) => {
        const animateKeyframes = buildKeyframes(safeFrom, safeTo);
