    ...
    <section className="relative w-full py-10 px-4 md:px-6 flex items-center justify-center min-[320px]:py-6">
      ...
      >
        ...
        <div className="relative p-px rounded-[2.5rem] overflow-hidden">
           ...
           <div className="relative bg-bg-paper rounded-[2.5rem] p-6 md:p-12 lg:p-16 border border-white/10 dark:border-white/5 overflow-hidden flex flex-col lg:flex-row items-center lg:items-center justify-between gap-12 lg:gap-20 box-border shadow-2xl shadow-black/5"
           ...
           >
              ...
              <div className="relative z-10 flex flex-col justify-center w-full lg:max-w-2xl space-y-6 md:space-y-8">
                  ...
                  <div className="flex flex-col sm:flex-row gap-4 pt-2 w-full sm:w-auto items-center sm:items-stretch">
                     ...
                     >
                        {copied ? <Check className="w-5 h-5 text-green-500" /> : <Copy className="w-5 h-5 text-fg-secondary group-hover:text-fg-primary" />}
              ...
              <div className="relative z-10 hidden lg:flex w-auto justify-end shrink-0">
                 <div className="bg-bg-surface/40 backdrop-blur-md p-6 rounded-3xl border border-white/20 dark:border-white/10 shadow-xl ring-1 ring-white/20 dark:ring-white/5">
                    <Calendar
                        ...
                        classNames={{
                            head_cell: "text-fg-tertiary font-medium text-[0.8rem] uppercase tracking-wider pb-2",
                            ...
                            day_outside: "text-fg-tertiary opacity-20 font-normal hover:bg-transparent hover:text-fg-tertiary cursor-default",
                            day_disabled: "text-fg-tertiary opacity-10",
                            day_range_middle:
                                "aria-selected:bg-accent aria-selected:text-accent-foreground",
                            day_hidden: "invisible",
                            nav_button: "border border-border-default hover:bg-bg-paper rounded-full shadow-xs transition-colors",
                            caption: "flex justify-center pt-1 relative items-center mb-4 text-fg-primary font-bold"
                        }}
                    />
                 </div>
              </div>
