          ...
          {isOpen && (
            ...
            >
              <div className="pt-2 pb-8 flex flex-col gap-6 sm:gap-8 w-full">
                {/* Hero Image */}
                <div
                  className="w-full aspect-video sm:aspect-[16/9] relative overflow-hidden bg-bg-surface border border-border-default/60 rounded-sm cursor-target group/img"
                  onClick={() =>
