  ...
  return (
    <>
      <section id="hero" className="relative w-[94%] max-w-6xl mx-auto flex flex-col items-center justify-start pt-0 pb-8 sm:pb-12 scroll-mt-24 md:scroll-mt-28">
        ...
        <div className="grid grid-cols-2 lg:grid-cols-6 lg:grid-rows-2 gap-1 w-full max-w-6xl mx-auto mt-4 sm:mt-6 lg:mt-6">
          ...
          >
            <motion.img
              src={profileImageSrc}
              alt="Bony Koshy"
              className="w-full h-full object-cover object-top grayscale md:hover:grayscale-0 transition-[filter] duration-300"
