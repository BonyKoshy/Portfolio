...
const LocationCard: React.FC = () => {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-panel rounded-xl group select-none cursor-default">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 pt-24 bg-linear-to-t from-panel via-panel/80 to-transparent flex flex-col justify-end items-center z-10">
