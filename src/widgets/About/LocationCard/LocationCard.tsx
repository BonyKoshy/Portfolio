...
const LocationCard: React.FC = () => {
  ...
  return (
    <div className="relative h-full w-full overflow-hidden bg-(--panel-bg) rounded-xl group select-none cursor-default">
      ...
      <div className="absolute bottom-0 left-0 right-0 p-6 pt-24 bg-linear-to-t from-(--panel-bg) via-(--panel-bg)/80 to-transparent flex flex-col justify-end items-center z-10">
        <div className="flex items-center gap-2 text-(--text-primary) translate-y-1 transition-transform duration-300 group-hover:translate-y-0">
          <MapPin className="text-(--accent) drop-shadow-[0_0_8px_var(--accent)]" size={18} />
