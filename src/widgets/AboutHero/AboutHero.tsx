...
const AboutHero = ({ isLoaded = true }: { isLoaded?: boolean }) => {
  ...
  const cards = [
    <Card
      key="profile"
      as="div"
      customClass="bg-bg-surface border-border-default border flex flex-col justify-between overflow-hidden cursor-default group shadow-2xl relative"
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-end p-8">
        <h3 className="text-3xl font-bold text-white mb-1">Bony Koshy</h3>
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-between p-10">
        ...
        <div>
          <h3 className="text-4xl font-bold text-fg-primary mb-6 group-hover:translate-x-2 transition-transform duration-300 whitespace-pre-line motion-reduce:transition-none motion-reduce:transition-none">
    ...
    >
      ...
      <div className="relative z-10 h-full flex flex-col justify-between p-10">
        <div className="flex justify-between items-start">
          <div className="flex items-center gap-4">
            <div className="h-12 w-12 rounded-xl bg-green-500/10 text-green-500 flex items-center justify-center shadow-lg shadow-green-500/10 group-hover:scale-110 transition-transform duration-300 border border-green-500/20 motion-reduce:transition-none motion-reduce:transition-none">
        ...
        <div>
          <h3 className="text-4xl font-bold text-fg-primary mb-2 group-hover:translate-x-2 transition-transform duration-300 whitespace-pre-line motion-reduce:transition-none motion-reduce:transition-none">
