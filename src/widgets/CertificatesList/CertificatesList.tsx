    ...
    >
      ...
      <div className="flex flex-col w-full mx-auto">
          ...
          {active && (
            <div className="fixed inset-0 grid place-items-center z-50 p-4">
              <motion.div
                ...
                ref={ref}
                className="w-[80%] max-h-[90vh] bg-bg-paper rounded-2xl overflow-hidden flex flex-col p-6 gap-6 relative"
              ...
              >
                ...
                <div className="flex items-start gap-4 max-[768px]:flex-col max-[768px]:items-center max-[768px]:text-center">
                  <motion.div layoutId={`image-${active.title}-${id}`}>
                    <img
                      src={active.src}
                      alt={active.title}
                      className="w-20 h-20 rounded-xl object-contain shrink-0 bg-bg-subtle"
                  ...
                  <div className="grow">
                    <motion.h3
                      ...
                      className="text-[1.25rem] font-bold m-0 text-fg-primary"
                    >
                      {active.title}
                    </motion.h3>
                    <motion.p
                      layoutId={`description-${active.description}-${id}`}
                      className="text-[0.9rem] text-fg-secondary mt-1"
                ...
                >
                  <div className="text-[1rem] leading-[1.7] text-fg-secondary overflow-y-auto pr-2 grow">
                  ...
                  <motion.a
                    ...
                    className="px-6 py-3 rounded-xl bg-primary text-primary-fg font-semibold no-underline transition-transform duration-200 mt-6 self-end hover:scale-105 max-[768px]:w-full"
        ...
        <ul className="list-none p-0 m-0 flex flex-col gap-4">
          {cards.map((card) => (
            <motion.li
              ...
              className="flex flex-wrap justify-between items-center p-4 rounded-xl bg-bg-paper cursor-pointer transition-all duration-200 shadow-sm hover:-translate-y-0.5 hover:bg-bg-subtle"
            ...
            >
              <div className="flex items-center gap-6 mb-2 sm:mb-0 w-full sm:w-auto max-[640px]:w-full max-[640px]:mb-4">
                ...
                <div>
                  ...
                  <motion.p
                    ...
                    className="text-fg-secondary text-[0.9rem]"
              ...
              <motion.a
                ...
                className="px-4 py-2 rounded-[10px] bg-primary text-primary-fg font-semibold text-[1.1rem] border-none cursor-pointer max-[640px]:w-full max-[640px]:text-center"
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="inline-flex justify-center items-center gap-2 w-full sm:w-auto px-4 py-3 bg-bg-paper text-fg-secondary rounded-full no-underline font-semibold transition-all duration-300 mt-8 shadow-sm self-end hover:bg-bg-subtle lg:w-auto lg:px-4 lg:py-2 lg:mt-8 lg:self-end"
