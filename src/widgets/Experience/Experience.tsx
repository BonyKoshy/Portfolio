        ...
        >
          {JOURNEY_MODULES.map((module, idx) => {
            ...
            return (
              ...
              >
                <div
                  className={`group relative border border-border-default bg-bg-default rounded-sm p-6 sm:p-8 flex flex-col h-[280px] xl:h-[300px] transition-all duration-300 group-hover/grid:opacity-40 hover:!opacity-100 hover:border-fg-primary overflow-hidden ${
                    ...
                    <div className="flex items-center gap-2 relative z-10">
                      ...
                      {isActive ? (
                        <span className="relative flex h-2 w-2 ml-1">
                          ...
                          <span className="absolute left-1/2 top-1/2 -translate-x-1/2 -translate-y-1/2 w-[2px] h-[2px] bg-primary/20 rounded-full scale-0 md:group-hover:scale-[600] transition-transform duration-700 ease-out z-[-1] hidden md:block pointer-events-none" />
                        </span>
                      ) : (
