      ...
      <div className="flex flex-col gap-1 w-full">
        ...
        <div className="w-full border border-border-default bg-bg-default rounded-sm px-5 sm:px-6 py-5 sm:py-6 flex flex-col gap-5 sm:gap-6 relative overflow-hidden">
          ...
          <div className="relative w-full overflow-hidden py-2">
            {/* Natural Edge Fades */}
            <div className="pointer-events-none absolute inset-y-0 left-0 w-10 sm:w-20 md:w-28 bg-gradient-to-r from-bg-default to-transparent z-10" />
            <div className="pointer-events-none absolute inset-y-0 right-0 w-10 sm:w-20 md:w-28 bg-gradient-to-l from-bg-default to-transparent z-10" />
