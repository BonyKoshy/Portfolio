    ...
    <>
      <header className="fixed top-0 left-0 w-full flex justify-between items-center px-8 py-6 z-60 pointer-events-none max-[768px]:p-4">
        ...
        <div className="flex items-center gap-6 relative z-60 pointer-events-auto">
          <ThemeToggle />
          <button
            className={`relative w-12 h-12 bg-panel border-none rounded-full cursor-pointer grid place-items-center z-1001 transition-colors duration-300 shadow-[0_0_20px_2px_rgba(0,0,0,0.05)] ${
              isMenuOpen ? "is-open" : ""
            } group`}
